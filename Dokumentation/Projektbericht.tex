...
\renewcommand{\todoname}{\addcontentsline{toc}{chapter}{Liste der ToDo's}Liste der ToDo's}
...
\input{Kapitel/2/Kinect.tex}
\input{Kapitel/3/Realisierung.tex}
\newpage
