...
%\FirmenLogoDeckblatt\hfill\includegraphics[width=4cm]{Bilder/dhbw-logo}\\[2cm] % Firmenlogo platzieren
\dhLogo\\[2cm]
...
\input{Kapitel/Grundlagen/Robotik.tex}
\input{Kapitel/Kinect/Kinect.tex}
\input{Kapitel/Nao/Nao.tex}
\input{Kapitel/Realisierung/Realisierung.tex}
...
\bibliographystyle{alpha}        % Zitierformat (deutsch für Großschreibung) [Häufigkeit] im Text
